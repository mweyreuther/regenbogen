<template>
  ...
  >
    <div class="flex items-center gap-1.5 mobile-landscape:flex-col">
      ...
      <div class="order-8 mx-0.5 h-5 w-px bg-slate-200 mobile-landscape:order-8 mobile-landscape:mx-0 mobile-landscape:my-0.5 mobile-landscape:h-px mobile-landscape:w-5 dark:bg-slate-600" />
      <div class="order-9 mobile-landscape:order-9 flex items-center gap-1.5 mobile-landscape:flex-col">
